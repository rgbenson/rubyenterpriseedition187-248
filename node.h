...
#define NEW_MASGN(l,r)   NEW_NODE(NODE_MASGN,l,0,r) // RGB FAIL
#define NEW_GASGN(v,val) NEW_NODE(NODE_GASGN,v,val,rb_global_entry(v)) // RGB FAIL
#define NEW_LASGN(v,val) NEW_NODE(NODE_LASGN,v,val,local_cnt(v))
#define NEW_DASGN(v,val) NEW_NODE(NODE_DASGN,v,val,0)
#define NEW_DASGN_CURR(v,val) NEW_NODE(NODE_DASGN_CURR,v,val,0)
#define NEW_IASGN(v,val) NEW_NODE(NODE_IASGN,v,val,0)
#define NEW_CDECL(v,val,path) NEW_NODE(NODE_CDECL,v,val,path) // RGB FAIL
...
#define NEW_DXSTR(s) NEW_NODE_LONGLIFE(NODE_DXSTR,REMEMBER(s),0,0)
...
#define NEW_BLOCK_PASS(b) NEW_NODE(NODE_BLOCK_PASS,0,b,0) // RGB FAIL
...
#define NEW_NEWLINE_LONGLIFE(n) NEW_NODE_LONGLIFE(NODE_NEWLINE,0,0,REMEMBER(n))
